...
class HashtagServiceTest {
    ...
    @DisplayName("해시태그 이름들을 입력하면, 저장된 해시태기 중 이름에 매칭하는 것들을 중복 없이 반환한다..")
    @Test
    void givenContent_whenParsing_thenReturnsUniqueHashtagNams(String input, Set<String> expected) {
        //given
    ...
    static Stream<Arguments> givenContent_whenParsing_thenReturnsUniqueHashtagNames() {
        return Stream.of(
                ...
                arguments(" #java, ?    #spring ... #부트", Set.of("java", "spring","부트")),
                arguments("#java    #spring 아주 긴~~~~~~~~~~~글~~~~~~~~~~~~", Set.of("java", "spring")),
                arguments(" 아주 긴~~~~~~~~~~~글~~~~~~~~~~~~ #java    #spring", Set.of("java", "spring"))
